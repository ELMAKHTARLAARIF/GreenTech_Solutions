...
Route::get('/Category', [ProduitController::class, 'filtrage'])->name('Category')->middleware('client');
Route::get('/categories', [ProduitController::class, 'ShowAllCategories'])->name('categories')->middleware('client');
...
Route::get('/add-product', [ProduitController::class, 'addProductForm'])
    ->name('addProduct')
    ->middleware('admin');
